							...
							<div class="card-header text-white" id="headingOne"
								...
								<ul class="nav nav-tabs card-header-tabs">
									<li class="nav-item " id="ViewUser"><a class="nav-link active text-white "
										style="background-color: #000080" href="#"><%=MaintConstant.MaintWork%></a></li>
									<li class="nav-item " id="NEWPO"><a class="nav-link text-light" href="../Service/NewServiceWork.jsp">
										<%=MaintConstant.New%> <%=MaintConstant.MaintWork%></a></li>
									<li class="nav-item " id="WtrTankInfoSummary"><a class="nav-link text-light"
										href="../MIS/WaterSupplySumSearch.jsp"><%=MaintConstant.MaintWork%> <%=MaintConstant.Summary%></a></li>
								</ul>
							</div>
							<div class="card-body text-dark h6">
								...
								<div class="form-row ">
									<div class="col-sm-4 offset-sm-2">
										<label for="ServiceType"><%=MaintConstant.Service%> <%=MaintConstant.Type%></label>
										<select id="ServiceType" name="ServiceType" 	class="form-control is-invalid">
										</select>
									</div>
									<div class="col-sm-4 offset-sm-0">
										...
										<select id="ActionType" name="ActionType" 	class="form-control is-invalid">
											...
											<option value="3"><%=MaintConstant.Remove%> </option>
										</select>
									</div>
								</div>
								<br />
								<div class="form-row ">
									<div class="col-sm-4 offset-sm-2">
									<label for="ServNo"><%=MaintConstant.Service%> <%=MaintConstant.Order%> <%=MaintConstant.NO%></label>
										<div class="input-group">
											<input type="text" class="form-control " id="ServNo" 	name="ServNo" >
										</div>
									</div>
									<div class="col-sm-4 offset-sm-0">
									<label for="ServProvider"><%=MaintConstant.Provider%> <%=MaintConstant.Name%></label>
										<div class="input-group">
											<input type="text" class="form-control " id="ServProvider" 	name="ServProvider" >
										</div>
									</div>
								</div>
								<br />
								...
								<div class="form-row">
									...
									<div class="col-sm-2 offset-sm-0">
										<button type="button" id ="submitMainServicePage01" class="form-control h5 text-white text-center "
											style="background-color: #38ACEC" name="submitMainServicePage01" ><%=Information.Submit%>
										</button>
									</div>
								</div>
