				...
				<div class="col-sm-12">
					<div class="card" Style="Padding-top:0px">
						<div class="card-header text-white" id="headingOne"
							...
							<ul class="nav nav-tabs card-header-tabs">
								<li class="nav-item " id="ViewUser"><a class="nav-link active text-white "
									style="background-color: #000080" href="#"><%=Information.MaterialPurchase%></a></li>
								<li class="nav-item " id="WtrTankNEW"><a class="nav-link text-light" href="NewMaterialPurchase.jsp">
									<%=Information.New%> <%=Information.MaterialPurchase%></a></li>
								<li class="nav-item " id="WtrTankInfoSummary"><a class="nav-link text-light"
									href="../MIS/WaterSupplySumSearch.jsp"><%=Information.MaterialPurchase%> <%=Information.Summary%></a></li>
							</ul>
						</div>
						<div class="card-body text-dark h6">
							...
							<div class="form-row ">
								...
								<div class="col-sm-4 offset-sm-0">
									...
									<select id="ActionType" name="ActionType" 	class="form-control is-invalid">
										...
										<option value="1"><%=Information.View%> <%=Information.MaterialPurchase%></option>
										<option value="2"><%=Information.Edit%> <%=Information.MaterialPurchase%></option>
										<option value="3"><%=Information.Remove%> <%=Information.MaterialPurchase%></option>
									</select>
								</div>
							</div>
							<br />
							<div class="form-row ">
								<div class="col-sm-4 offset-sm-2">
									<label for="TankerNo"><%=Information.InvoiceNo%></label>
									<div class="input-group">
										<input type="text" class="form-control is-invalid" 	id="InvoiceNo" name="InvoiceNo" required>
									</div>
								</div>
								<div class="col-sm-4 offset-sm-0">
									<label for="DateFrom"><%=Information.Date%></label>
									<div class="input-group">
