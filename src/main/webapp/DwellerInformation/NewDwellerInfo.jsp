...
<html>
	...
	<!-- Body -->
	<div class="container">                           
		   	<form id="DwellerNEW" name="DwellerNEW" action="../DwellerNewInfoCheck" method="post" class="form-horizontal needs-validation" autocomplete="off">		
			<div class="row">
			    <div class="col-xs-12">
    								...
    								<br />
	  								...
	  								<div class="form-row">
 										<div class="col-lg-3 offset-sm-1 ">
    										 ...
    										 <input type="date" class="form-control is-invalid" id="inputShiftIn" name="inputShiftIn" placeholder=""  required>
										</div>
										<div class="col-lg-3 offset-sm-0 ">
									...
									<br /> <br />
  									...
  									<div class="form-group col-lg-4 ">
    									<label for="inputOwnMobile"><%=Information.mobile%></label>
     									 <input type="text" class="form-control is-invalid" id="inputOwnMobile" name="inputOwnMobile" placeholder=""  required>
 									</div>
								</div>
<%-- 								<div class="form-row ">
