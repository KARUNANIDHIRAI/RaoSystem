...
<body>
	...
	<div class="container">
		<form id="TNTInfo" name="TNTInfo" action="../DwellerInformation" method="post"
						...
						<div class="card">
							<div class="card-header text-white" id="headingOne" style="background-color:#38ACEC">
								...
								<ul class="nav nav-tabs card-header-tabs">
									<li class="nav-item " id="ViewUser" > 
										...
										<%= Information.TNTViewInfo%></a></li>
									<li class="nav-item " id="SSPNEW">
										<a class="nav-link text-light" href="NewDwellerInfo.jsp"><%= Information.TNTNewInfo%></a></li>
								</ul>
							</div>
							...
							<div id="collapseOne" class="collapse show"
								...
								<div class="card-body text-dark h6" >
									...
									<div class="form-row ">
										<div class="col-sm-4 offset-sm-2">
											<label for="MobileNo" ><%=Information.MobileNo%></label>
											<div class="input-group">
												<input type="text" class="form-control is-invalid"	id="MobileNo" name="MobileNo" required>
											</div>
										</div>
