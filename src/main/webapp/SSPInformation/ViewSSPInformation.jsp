...
<html>
	...
	<div class="container"> 
		   	...
		   	<form id="SSPEDIT" name="SSPEDIT" action="SSPInfoCheck" method="post" class="form-signin form-horizontal" autocomplete="off">		
			<div class="row">
			    <div class="col-xs-12">
      							...
      							<div class="card-body " style="background-color:#EFEBE9  ;" >
									<div class="form-row ">
   										<div class="col-lg-4 offset-sm-1">
     										 <label for="inputName"><%=Information.fname%></label>
      										 <input type="text" class="form-control " id="inputFName" name="inputFName" placeholder="" value=<%=session.getAttribute("inputFName") %> required>
  										</div>
  										<div class="col-lg-3 offset-sm-0">
  											<label  for="inputName"><%=Information.lname%></label>
      										 <input type="text" class="form-control " id="inputLName" name="inputLName" placeholder="" value=<%=session.getAttribute("inputLName") %> >
										</div>
 									...
 									<div class="form-row ">
   										<div class="col-lg-4 offset-sm-1">
     										 <label for="inputDOB"><%=Information.dob%></label>
      										 <input type="date" class="form-control " id="inputDOB" name="inputDOB" placeholder="" value=<%=session.getAttribute("inputDOB") %> required>
  										</div>
   										<div class="form-group col-lg-3">
     										 <label for="inputPanCardNo"><%=Information.PanNo%></label>
      										 <input type="text" class="form-control " id="inputPanCardNo" name="inputPanCardNo" placeholder="" value=<%=session.getAttribute("inputPanCardNo") %> reuired>
  										</div>
 									</div>
    									...
    									<div class="form-group col-lg-4 offset-sm-1">
    										<label for="inputEmail4"><%=Information.email%></label>
     										<input type="email" class="form-control " id="inputEmail4" name="inputEmail4" placeholder="email@example.com"  
   											data-toggle="tooltip" data-placement="top" title="We'll never share your email with anyone else." value=<%=session.getAttribute("inputEmail4") %> required>
   										</div>
   										<div class="form-group col-lg-3 ">
     										<label for="inputMobile"><%=Information.mobile%></label>
      										 <input type="text" class="form-control " id="inputMobile" name="inputMobile" placeholder="" value=<%=session.getAttribute("inputMobile") %> required>
  										</div>
  										<div class="form-group col-lg-3">
      										<label for="inputAadharNO"><%=Information.aadhar%></label>
     										<input type="text" class="form-control " id="inputAadharNO" name="inputAadharNO" placeholder="" value=<%=session.getAttribute("inputAadharNO") %> required>
   										</div>
 									</div>
									<br/>
									<div class="form-row">
 										<div class="col-lg-4 offset-sm-1 h6">
    										 ...
    										 <input type="text" class="form-control " id="inputFFName" name="inputFFName" placeholder="" value=<%=session.getAttribute("inputFFName") %> required>
										</div>
										<div class="col-lg-3 offset-sm-0 h6">
											<label  for="inputFLName"><%=Information.lname%></label>
    										 <input type="text" class="form-control " id="inputFLName" name="inputFLName" placeholder="" value=<%=session.getAttribute("inputFLName") %> >
										</div>
									...
									<div class="form-row">
 										...
 										<div class="form-group col-lg-3 offset-sm-0">
    										 ...
    										 <input type="text" class="form-control " id="inputFMobile" name="inputFMobile" placeholder="" value=<%=session.getAttribute("inputFMobile") %> required>
										</div>
										<div class="form-group col-lg-3 offset-sm-0">
    										<label for="inputFAadharNO"><%=Information.aadhar%></label>
   											<input type="text" class="form-control " id="inputFAadharNO" name="inputFAadharNO" placeholder="" value=<%=session.getAttribute("inputFAadharNO") %> required>
 										</div>
									</div>
									<br />
									<div class="form-row ">
      							...
      							<div class="card-body " style="background-color:#EFEBE9  ;">
       								<div class="form-row">
  										<div class="form-group col-md-6 offset-md-1">
   										 	...
   										 	<input type="text" class="form-control   " id="inputPAddress" placeholder="Flat NO/ Floor no/ Apartment / towerNO" 
	  								...
	  								<div class="form-row">
  										<div class="form-group col-md-3 offset-sm-1">
      										...
      										<input type="text" class="form-control   " id="inputCCity" name="inputCCity" value=<%=session.getAttribute("inputCCity") %>>
    									</div>
    									<div class="form-group col-md-3 offset-sm-0">

	      									<label for="inputCState"><%= Information.state%></label>
      										<input type="text" class="form-control " id="inputCState" name="inputCState" value=<%=session.getAttribute("inputCState") %>>
	    								</div>
	    								<div class="form-group col-md-2">
	      									<label for="inputCCountry"><%= Information.country%></label>
      										<input type="text" class="form-control " id="inputCCountry" name="inputCCountry" value=<%=session.getAttribute("inputCCountry") %>>
	    								</div>
	    								<div class="form-group col-md-2">
									...
									<div class="form-row">
 										<div class="col-sm-3 offset-sm-1">
    										 ...
    										 <input type="text" class="form-control  " id="inputLicenseNO" name="inputLicenseNO" placeholder="" 
    										 	value=<%=session.getAttribute("inputLicenseNO") %> required>
										</div>
										<div class="col-sm-3">
 										...
 										<div class="col-sm-2 ">
    										 ...
    										 <input type="date" class="form-control  " id="inputLicenseDate" name="inputLicenseDate" placeholder="" 
    										 	value=<%=session.getAttribute("inputLicenseDate") %> required>
										</div>
										<div class="col-sm-2">
