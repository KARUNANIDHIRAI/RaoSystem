									...
									<div class="form-row ">
   										<div class="col-lg-4 offset-sm-1">
     										 <label for="inputName"><%=Information.fname%></label>
      										 <input type="text" class="form-control is-invalid" id="inputFName" name="inputFName" placeholder="" value=<%=session.getAttribute("inputFName") %> required>
  										</div>
  										<div class="col-lg-3 offset-sm-0">
  											<label  for="inputName"><%=Information.lname%></label>
      										 <input type="text" class="form-control is-invalid" id="inputLName" name="inputLName" placeholder="" value=<%=session.getAttribute("inputLName") %>  >
										</div>
 									...
 									<div class="form-row ">
   										<div class="col-lg-4 offset-sm-1">
     										 <label for="inputDOB"><%=Information.dob%></label>
      										 <input type="date" class="form-control is-invalid" id="inputDOB" name="inputDOB" placeholder="" value=<%=session.getAttribute("inputDOB") %> required>
  										</div>
   										<div class="form-group col-lg-3">
     										 <label for="inputPanCardNo"><%=Information.PanNo%></label>
      										 <input type="text" class="form-control is-invalid " id="inputPanCardNo" name="inputPanCardNo" placeholder=""  value=<%=session.getAttribute("inputPanCardNo") %> required>
  										</div>
 									</div>
