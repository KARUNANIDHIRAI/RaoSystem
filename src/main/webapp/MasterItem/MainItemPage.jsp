					...
					<div class="col-sm-12">
						<div class="card" Style="Padding-top:0px">
							...
							<div class="card-body text-dark h6">
								...
								<div class="form-row ">
									...
									<div class="col-sm-4 offset-sm-0">
										...
										<select id="ActionType" name="ActionType" 	class="form-control is-invalid">
											...
											<option value="3"><%=ItemConstant.Remove%> </option>
										</select>
									</div>
								</div>
								<br />
								<div class="form-row ">
									<div class="col-sm-4 offset-sm-2">
									<label for="itemCode"><%=ItemConstant.Item%> <%=ItemConstant.Code%> </label>
										<div class="input-group">
											<input type="text" class="form-control " id="itemCode" 	name="itemCode" >
										</div>
									</div>
									<div class="col-sm-4 offset-sm-0">
									<label for="itemName"><%=ItemConstant.Item%> <%=ItemConstant.Name%></label>
										<div class="input-group">
