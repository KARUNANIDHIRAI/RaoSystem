...
<html>
	...
	<body>
		...
		<div class="container">
			<form id="PDInfo" name="PDInfo" action="../ContactUsInfo?Action=PFDEnquiry" method="post"
			 class="form-horizontal form-horizontal needs-validation" autocomplete="off" >
				<div class="row justify-content-md-center">
					<div class="col-sm-10 offset-sm-1 text-center">
						<h4> Product Demo Enquiry: Contact to our team</h4>
					</div>
				</div>
				<div class="row ">
					<div class="col-sm-10 offset-sm-1 text-center">
				...
				<div class="bg-light col-sm-10 offset-sm-1">
					...
					<div class="row">		
						<div class="col-sm-5 offset-sm-1">
							<input type="text" class="form-control blineb " id="fName" 	name="fName" placeholder="First Name*" required
								   pattern="[A-Za-z\s+]{3,100}" title="Enter character between a-z or A-Z ">
						</div>
						<div class="col-sm-5 offset-sm-0">
							<input type="text" class="form-control blineb" id="lName" 	name="lName" placeholder="Last Name*" required
							  pattern="[A-Za-z\s+]{3,100}" title="Enter character between a-z or A-Z">
						</div>
					</div>
					<br />
					<div class="row">		
						<div class="col-sm-5 offset-sm-1">
							<input type="email" class="form-control blineb" id="email" name="email" required placeholder="Email*" >
						</div>
						<div class="col-sm-5 offset-sm-0">
							<input type="text" class="form-control blineb " id="companyName" 	name="companyName" placeholder="Company Name**"
							pattern="[A-Za-z\s+]{0,40}" title="Enter character between a-z or A-Z " >
						</div>
					</div>
					<br />
					<div class="row">		
						<div class="col-sm-5 offset-sm-1">
							<select id="country" name="country" 	class="form-control in-valid blineb" required >
								<option selected value ="0">Select Country Name</option>
							</select>
						</div>
						<div class="col-sm-5 offset-sm-0">
							<input type="text" class="form-control blineb" id="city" 	name="city" required
							pattern="[A-Za-z\s+]{4,40}" title="Enter character between a-z or A-Z " placeholder="City Name*" >
						</div>
					</div>
					<br />
					<div class="row">		
						<div class="col-sm-5 offset-sm-1">
							...
							pattern="[0-9]{6,10}" title="Enter digits between 0-9 max length 6-8 digits" placeholder="Postal Code*" >
						</div>
						<div class="col-sm-5 offset-sm-0">
							<input type="text" class="form-control blineb" id="phoneNo" 	name="phoneNo" 
							pattern="[0-9\S+]{6,20}" title="Enter digits between 0-9 " required placeholder="Phone (+91 XXXXXXXXXX)*" >
						</div>
					</div>
					<br />
					<div class="row">		
						<div class="col-sm-5 offset-sm-1">
							<select id="prodDemo" name="prodDemo" class="form-control blineb"  	data-toggle="tooltip" title="">
					...
					<div class="row">		
						<div class="form-group col-sm-10 offset-sm-1">
							...
							<textarea class="form-control blineb"  maxlength="500" rows="5"  id="textareaMsg" 	name="textareaMsg" > </textarea>
