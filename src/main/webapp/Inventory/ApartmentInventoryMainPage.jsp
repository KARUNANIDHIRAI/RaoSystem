...
<body>
	...
	<div class="container">
		<form id="IndvidualInfo" name="IndvidualInfo" action="../ShowAPTInventoryInfo" method="post"
							...
							<div class="card-header text-white" id="headingOne" style="background-color:#38ACEC">
								...
								<ul class="nav nav-tabs card-header-tabs">
									...
									<li class="nav-item " id="SSPNEW">
										<a class="nav-link text-light" href="../Inventory/NewAPTInventroy.jsp"><%= Information.NewAPTInfo%></a></li>
 								</ul>
							</div>
									...
									<div class="form-row ">
									    ...
									    <div class="col-sm-4 offset-sm-0">
										    ...
										    data-toggle="tooltip" data-placement="top" title="For Individual Apartment Please Enter Apartment / Tower No."  >
												<option value="1">Individual Apartment</option>
												<option value="2">All Apartment Inventory </option>
										    </select>
								    	</div>
									</div>
									<br />
 									<div class="form-row ">
									    <div class="col-sm-4 offset-sm-2">
									      	<label for="AptTowerNo" ><%= Information.AptTowerNo%></label>
											<div class="input-group">
												<input type="text" class="form-control is-valid"	id="AptTowerNo" name="AptTowerNo" required>
											</div>
								    	</div>
									</div>
									<br />
