...
<body >
	...
	<div class="container" >
		<form id="AptInfo" name="AptInfo" action="../EditAPTInventory" method="post" class="form-horizontal needs-validation" autocomplete="off">
									...
									<div class="col-sm-3 offset-sm-1">
										...
										<div class="input-group">
											<input type="text" class="form-control is-invalid"
												id="inputTowerNo" name="inputTowerNo" value=<%=session.getAttribute("inputTowerNo") %>
												readonly>
										</div>
									</div>
									<div class="col-sm-3 offset-sm-1">
										...
										<div class="input-group">
											<input type="text" class="form-control is-invalid"
												...
												title="Enter Flat Type Number" value=<%=session.getAttribute("inputFlatCategoryNo") %>
												readonly>
										</div>
									</div>
									<div class="col-sm-3 offset-sm-1">
										...
										<div class="input-group">
											<input type="text" class="form-control is-invalid"
												...
												data-toggle="tooltip" data-placement="top"
												title="Enter Flat Type Number" value=<%=session.getAttribute("inputSizeOfFlat") %>>
										</div>
									</div>
								</div>
								<div class="form-row">
									<div class="col-sm-3 offset-sm-1">
										...
										<div class="input-group">
											<input type="text" class="form-control is-invalid"
												...
												data-placement="top" title="Enter Total Numbsers of Flat in Flat Type"
												 value=<%=session.getAttribute("inputFltStartNo") %>>
										</div>
									</div>
									<div class="col-sm-3 offset-sm-1">
										...
										<div class="input-group">
											<input type="text" class="form-control is-invalid"	id="inputFltEndNo"
												...
												value=<%=session.getAttribute("inputFltEndNo") %> 	>
										</div>
									</div>
								</div>
								<br /> <br />  
