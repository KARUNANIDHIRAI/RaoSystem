				...
				<div class="col-sm-12">
 					<div class="card" >
						<div class="card-header text-center " >
							<h5 class="card-title text-center"><%=Information.RwaMonthlyPlan%></h5>
						</div>
					</div>
<!-- 					<div class="card"> -->
...
<!-- 					</div> -->
						...
						<div class="col-sm-12 offset-sm-0">
							<table id="datatable" class="hover display nowrap" style="width: 100%">
								...
								<tbody>
								    <tr>
										<td><%=session.getAttribute("SubscriptionType")%></td>
										<td><%=session.getAttribute("ValidDateFrom")%> </td>
										<td><%=session.getAttribute("ValidDateTo")%></td>
										<td><%=session.getAttribute("Fixcharge")%></td>
										<td><%=session.getAttribute("AmcCharge")%></td>
										<td><%=session.getAttribute("AuditCharge")%> </td>
										<td><%=session.getAttribute("GymCharge")%></td>
										<td><%=session.getAttribute("SwimmingPoolCharge")%></td>
										<td><%=session.getAttribute("MiscCharge")%></td>
									</tr>
								</tbody>
							</table>
						</div>
