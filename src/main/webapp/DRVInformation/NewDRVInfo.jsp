...
<html>
	...
	<div class="container"> 
		   	...
		   	<form id="DRVNEW" name="DRVNEW" action="../DRVInfoCheck" method="post" class="form-signin form-horizontal needs-validation" autocomplete="off">		
			<div class="row">
			    <div class="col-xs-12">
      							...
      							<div class="card-body" style="background-color:#FAF7F5  ;">
									...
									<div class="form-row">
 										<div class="col-sm-3 offset-sm-0">
    										 ...
    										 <input type="text" class="form-control is-invalid " id="inputLicenseNO" name="inputLicenseNO" placeholder="" >
										</div>
										<div class="col-sm-3">
