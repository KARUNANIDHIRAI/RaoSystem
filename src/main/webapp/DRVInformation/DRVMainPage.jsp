...
<body>
	...
	<div class="container">
		<form id="DRVInfo" name="DRVInfo" action="../DRVInformation" method="post"
							...
							<div class="card-header text-white" id="headingOne" style="background-color:#38ACEC">
								...
								<ul class="nav nav-tabs card-header-tabs">
									<li class="nav-item " id="ViewUser"> 
										<a	class="nav-link active text-dark " href="#"><%= Information.ViewInfo%></a></li>
									<li class="nav-item " id="SSPNEW">
										<a class="nav-link text-light" href="../DRVInformation/NewDRVInfo.jsp"><%= Information.NewInfo%></a></li>
								</ul>
							</div>
