...
<html>
	...
	<!-- Body -->
	<div class="container">                           
		   	<form id="HKMNEW" name="HKMNEW" action="../FlatOwnerUpdateInfoCehck" method="post" class="form-horizontal needs-validation" autocomplete="off">		
			<div class="row">
			    <div class="col-xs-12">
									...
									<div class="form-row ">
   										<div class="col-lg-4 offset-sm-1">
     										 <label for="inputName"><%=Information.fname%></label>
      										 <input type="text" class="form-control is-invalid" id="inputFName" name="inputFName" 
      										 value=<%=session.getAttribute("inputFName") %> placeholder=""  required >
  										</div>
  										<div class="col-lg-3 offset-sm-0">
  											<label  for="inputName"><%=Information.lname%></label>
      										 <input type="text" class="form-control is-invalid" id="inputLName" name="inputLName" 
      										 value=<%=session.getAttribute("inputLName") %> placeholder=""  >
										</div>
 									...
 									<div class="form-row">
    									<div class="form-group col-lg-4 offset-sm-1">
    										<label for="inputEmail4"><%=Information.email%></label>
     										...
     										value=<%=session.getAttribute("inputEmail4") %> placeholder="email@example.com"  
   										...
   										<div class="form-group col-lg-3 ">
     										<label for="inputMobile"><%=Information.mobile%></label>
      										 <input type="text" class="form-control is-invalid" id="inputMobile" name="inputMobile"
      										 value=<%=session.getAttribute("inputMobile") %> placeholder=""  required readonly>
  										</div>
 									</div>
									<br/>
									<div class="form-row">
 										<div class="col-lg-4 offset-sm-1 h6">
    										 ...
    										 <input type="text" class="form-control is-invalid" id="inputFFName" name="inputFFName" 
    										 value=<%=session.getAttribute("inputFFName") %> placeholder=""  required>
										</div>
										<div class="col-lg-3 offset-sm-0 h6">
											<label  for="inputFLName"><%=Information.lname%></label>
    										 <input type="text" class="form-control is-invalid" id="inputFLName" name="inputFLName" 
    										 value=<%=session.getAttribute("inputFLName") %> placeholder=""  >
										</div>
      							...
      							<div class="card-body " style="background-color:#FAF7F5  ;">
       								...
       								<div class="form-row">
  										<div class="form-group col-md-6 offset-md-1">
   										 	...
   										 	<input type="text" class="form-control  is-invalid " id="inputPAddress" name="inputPAddress"
   										 	value=<%=session.getAttribute("inputPAddress") %> placeholder="Flat NO/ Floor no/ Apartment / towerNO" >
  										</div>
  						
  										<div class="form-group col-md-2">
   							 				<label for="inputBlock"><%= Information.Block%></label>
    										<input type="text" class="form-control   " id="inputBlock" placeholder="" 
    										 name="inputBlock" value=<%=session.getAttribute("inputBlock") %>>	
      							...
      							<div class="card-body " style="background-color:#FAF7F5  ;">
									<div class="form-row">
  									 	<div class="form-group col-md-4 offset-sm-1 h6">
							 				...
							 				<input type="text" class="form-control" id="inputPreOrgName" name="inputPreOrgName" 
							 				value=<%=session.getAttribute("inputPreOrgName") %> placeholder="" >
							 					
  										 </div>
  										 <div class="form-group col-md-3">
   							 				<label for="inputEmpNO"><%= Information.EmplNoLBL%></label>
    										<input type="text" class="form-control   " id="inputEmpNO" name="inputEmpNO" 
    										value=<%=session.getAttribute("inputEmpNO") %> placeholder="" >
  										</div>
  										<div class="form-group col-md-3">
    										...
    										value=<%=session.getAttribute("inputDesignation") %> placeholder="">
  										</div>
 	  								</div>
									<div class="form-row">
  										<div class="form-group col-md-6 offset-md-1">
   										 	...
   										 	value=<%=session.getAttribute("inputOAddress") %> placeholder="Flat NO/ Floor no/ Apartment / towerNO" >
  										</div>
									...
									<div class="form-row ">
   										<div class="col-lg-4 offset-sm-1">
     										 <label for="inputDRVFName"><%=Information.fname%></label>
      										 <input type="text" class="form-control " id="inputDRVFName" name="inputDRVFName" 
      										 value=<%=session.getAttribute("inputDRVFName") %> placeholder=""  >
  										</div>
  										<div class="col-lg-3 offset-sm-0">
  											<label  for="inputDRVLName"><%=Information.lname%></label>
      										 <input type="text" class="form-control " id="inputDRVLName" name="inputDRVLName" 
      										 value=<%=session.getAttribute("inputDRVLName") %> placeholder=""  >
										</div>
										<div class="form-group col-lg-3 offset-sm-0">
 									...
 									<div class="form-row">
    									<div class="form-group col-lg-4 offset-sm-1">
    										<label for="inputDRVAadharNo"><%=Information.AadharNo%></label>
     										<input type="text" class="form-control " id="inputDRVAadharNo" name="inputDRVAadharNo"
     										value=<%=session.getAttribute("inputDRVAadharNo") %> placeholder=""  
   											data-toggle="tooltip" data-placement="top" title="Pls enter Valid Aadhar No." >
   										</div>
   										<div class="form-group col-lg-3 ">
     										<label for="inputDRVMobile"><%=Information.mobile%></label>
      										 <input type="text" class="form-control " id="inputDRVMobile" name="inputDRVMobile"
      										 value=<%=session.getAttribute("inputDRVMobile") %> placeholder=""  >
  										</div>
   										<div class="form-group col-lg-3 ">
     										<label for="inputDRVDlNo"><%=Information.DlNo%></label>
      										 <input type="text" class="form-control " id="inputDRVDlNo" name="inputDRVDlNo" 
      										 value=<%=session.getAttribute("inputDRVDlNo") %> placeholder=""  >
  										</div>
 									</div>
									<div class="form-row ">
									...
									<div class="form-row ">
   										<div class="col-lg-4 offset-sm-1">
     										 <label for="inputHKMName"><%=Information.fname%></label>
      										 <input type="text" class="form-control " id="inputHKMName" name="inputHKMName" 
      										 value=<%=session.getAttribute("inputHKMName") %> placeholder=""  >
  										</div>
  										<div class="col-lg-3 offset-sm-0">
  											<label  for="inputHKMLName"><%=Information.lname%></label>
      										 <input type="text" class="form-control " id="inputHKMLName" name="inputHKMLName" 
      										 value=<%=session.getAttribute("inputHKMLName") %> placeholder=""  >
										</div>
										<div class="form-group col-lg-3 offset-sm-0">
 									...
 									<div class="form-row">
    									<div class="form-group col-lg-4 offset-sm-1">
    										<label for="inputHKMAadharNo"><%=Information.AadharNo%></label>
     										<input type="text" class="form-control " id="inputHKMAadharNo" name="inputHKMAadharNo"
     										value=<%=session.getAttribute("inputHKMAadharNo") %>  placeholder=""  
   											data-toggle="tooltip" data-placement="top" title="Pls enter Valid Aadhar No." >
   										</div>
   										<div class="form-group col-lg-3 ">
     										<label for="inputHKMMobile"><%=Information.mobile%></label>
      										 <input type="text" class="form-control " id="inputHKMMobile" name="inputHKMMobile" 
      										 value=<%=session.getAttribute("inputHKMMobile") %> placeholder=""  >
  										</div>
 									</div>
									<div class="form-row ">
								    	<div class="col-sm-11 offset-sm-1">
