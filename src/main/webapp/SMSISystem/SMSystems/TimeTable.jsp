...
<%-- 							<div class="col-sm-5 offset-sm-0  form-group">
							    <label for="teacher01"> <%=SMFixedValue.TEACHER%> <%=SMFixedValue.Name%>  </label>
								<input type="text" class="form-control blineTl H6 " id="teacher01" name="teacher01">
	 						</div>
 --%>
 						</div>	
						<div class="row">		
			...
			function TimeTable(result){
				...
				$('#ClassTimeTable').dataTable({
				    ...
				    "columns": [
			    		 ...
			    		 { title:	'Remove'           ,data:"TTIDNOFK",
					     	"render": function(data,type,row,meta){
					       	 	return	'<button type="button" name="xTTData" align="middle" value="'+data+'" class="bg-warning text-dark" data-toggle="tooltip" data-placement="right" title="Click to Remove " ><span> &#9988; </span> </button>'; 
			        		},
				        }
					]
				}); 
