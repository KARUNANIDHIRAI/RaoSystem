							...
							<div class="card-body text-dark h6">
								...
								<div class="form-row ">
									<div class="col-sm-4 offset-sm-2">
										<label for="rwaRegNo"><%=SMFixedValue.RegNo%> </label>
									...
									<div class="col-sm-4 offset-sm-0">
										...
										<select id="ActionType" name="ActionType" 	class="form-control is-invalid">
											...
											<option value="1"><%=SMFixedValue.View%> </option>
											<option value="2"><%=SMFixedValue.Edit%> </option>
											<option value="3"><%=SMFixedValue.Remove%> </option>
										</select>
									</div>
								</div>
								<br />
								<div class="form-row ">
									<div class="col-sm-4 offset-sm-2">
									<label for="itemCode"><%=SMFixedValue.Item%> <%=SMFixedValue.Code%> </label>
										<div class="input-group">
											<input type="text" class="form-control " id="itemCode" 	name="itemCode" >
										</div>
									</div>
									<div class="col-sm-4 offset-sm-0">
									<label for="itemName"><%=SMFixedValue.Item%> <%=SMFixedValue.Name%></label>
										<div class="input-group">
