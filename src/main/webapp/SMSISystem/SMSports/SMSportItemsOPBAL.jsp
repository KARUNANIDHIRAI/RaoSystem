							...
							<div class="card-header text-white" id="headingOne"
								...
								<ul class="nav nav-tabs card-header-tabs">
									<li class="nav-item " id="ViewUser"><a class="nav-link active text-white "
										style="background-color: #000080" href="#"> <%=SMFixedValue.SPORTS%> <%=SMFixedValue.ITEM%> <%=SMFixedValue.Master%> <%=SMFixedValue.CREATE%>  </a></li>
									<li class="nav-item " id="xRBkMSInfoX"><a class="nav-link text-light" href="#">
										<%=SMFixedValue.View%>  <%=SMFixedValue.SPORTS%> <%=SMFixedValue.INFORMATION%> </a></li>
								</ul>
							</div>
						</div>				
					</div>
				...
				<div class="bg-light col-sm-12 offset-sm-0 ">
					...
					<div class="row">
						...
						<div class="col-sm-4 offset-sm-3">
						    <label for="Category" class ="h6 "><%=SMFixedValue.SPORTS%> <%=SMFixedValue.ITEM%> <%=SMFixedValue.CATEGORY%>* </label>
					...
					<div class="row">
						<div class="col-sm-4 offset-sm-0">
						    <label for="bkCode" class ="h6"><%=SMFixedValue.ITEM%> <%=SMFixedValue.Code%>* </label>
							<input type="text" class="form-control   blineTl " id="bkCode" 	name="bkCode"  required
							pattern="[A-Za-z0-9]" value='BK101'>
						</div>
						<div class="col-sm-4 offset-sm-0">
						    <label for="bkTitle" class ="h6"><%=SMFixedValue.ITEM%> <%=SMFixedValue.Name%>* </label>
						...
						<div class="col-sm-4 offset-sm-0">
						    <label for="bkAuthor" class ="h6"><%=SMFixedValue.MAKE%>* </label>
					...
					<div class="row">		
						<div class="col-sm-4 offset-sm-0">
						    <label for="bkPubName" class ="h6"><%=SMFixedValue.MANUFACTURING_YEAR%> *</label>
						...
						<div class="col-sm-2 offset-sm-0">
							<label for="bkEdition" class="form-label h6"><%=SMFixedValue.EXPIRY_DATE%>*</label>
							<input type="text" class="form-control blineTl" id="bkEdition" name="bkEdition" 
							pattern="[A-Za-z0-9,-_.\s]{2,100}" required value='2021'>
						</div>
						<div class="col-sm-2 offset-sm-0">
						    <label for="bkQty" class ="h6"> <%=SMFixedValue.QUANTITY%>* </label>
						...
						<div class="col-sm-2 offset-sm-0">
						    <label for="bkPrice" class ="h6"><%=SMFixedValue.PRICE%>* </label>
				...
				<div class="form-row">
					<div class="col-sm-10 offset-sm-1" >  <!--  showing data into table -->
						<div class="table-responsive ">
							<table id="SportMasterList" class="table table-striped table-hover compact row-border"  style="width:100%; font-size: 12px;"> </table>
						</div>
					</div>
				</div>	
			</form>
