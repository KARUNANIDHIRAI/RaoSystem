...
<!--boody  -->
		...
		<div class="container" > 
			<form id="PWDreset" name="PWDreset" action="verifyUserLoginID" method="post" class="form-signin form-horizontal" autocomplete="off" >
					...
					<div class="col-sm-12">
						...
						<div class="form-row" >
							<div class="h5  col-sm-6 offset-sm-3 "> 
					    		<p class="text-danger "><%= session.getAttribute("InvalidFPWDMsg")== null?"":session.getAttribute("InvalidLoginMsg") %></p>
