...
<html>
	...
	<!-- Body -->
	<div class="container">                           
		   	<form id="HKMNEW" name="HKMNEW" action="../HKMNewInfoCheck" method="post" class="form-horizontal needs-validation" autocomplete="off">		
			<div class="row">
			    <div class="col-xs-12">
  						...
  						<div class="card">
    						<div class="card-header  text-white" id="headingOne" style="background-color:#2EA2E2">
					      			...
					      			<li class="nav-item " data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
					      			 <a class="nav-link active  text-white " href="#" style="background-color:#000080"><%=Information.HKMPersonalInfo %></a> </li>
					      			<li class="nav-item " data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
					      			 <a class="nav-link text-light" href="#"><%= Information.HKMAddress%></a> </li>
