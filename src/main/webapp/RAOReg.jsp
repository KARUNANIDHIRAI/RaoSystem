							...
							<div class="card-header bg-primary text-white text-center" style="max-height: 60px; padding-top:0px; padding-bottom:0px;" >
						  	...
						  	<div class="card-body">
								...
								<div class="form-group row">
									...
									<div class="col-sm-2">
				 				 		<input class="form-control input-sm btn btn-warning" type ="submit" value="login"  >
									</div>
								</div>
								<div class="form-group row ">
									...
									<div class="col-sm-5">
										...
										<p>
											<%=Information.FirstTimeUser %><a href="Registration.jsp" data-toggle="tooltip" title="click for Registertion"><span class ="h6 col-xs-5"><%= Information.RegisterNow%></span></a>						
										</p>
									</div>
								</div>
				 			</div>	
