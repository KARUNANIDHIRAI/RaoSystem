...
<body>
	...
	<div class="container">
		<form id="SrchUserSearch" name="UserSearch" action="SearchUser" method="post"
							...
							<div class="card-header bg-primary" id="headingOne">
								...
								<ul class="nav nav-tabs card-header-tabs">
									<li class="nav-item " id="ViewUser"> 
										<a	class="nav-link active text-dark " href="#">View User Information</a></li>
									<li class="nav-item " >
										<a class="nav-link text-light" href="userLoginRegistration.jsp">Create New User</a></li>
									<li class="nav-item "  id="EditUserIfon"><a
										class="nav-link text-light" href="#">Edit User Information</a></li> 
<!-- 										userInfoPreview.jsp -->
									<li class="nav-item " >
							...
							<div id="collapseOne" class="collapse show"
								...
								<div class="card-body bg-light text-dark h6">
									...
									<div class="form-row ">
										...
										<div class="col-sm-3">
											<label for="rwaRegNo" class="form-control-sm "><%=Information.RwaCode%></label>
											<div class="input-group">
												<input type="text" class="form-control"	id="rwaRegNo" name="rwaRegNo" required>
											</div>
										</div>
									</div>
									<br /> <br />
						...
						<div class="card">
							<div id="collapseTwo" class="collapse "
								aria-labelledby="headingTwo" data-parent="#accordionDriver">
								<div class="card-body">
								</div>
							</div>
						</div>
