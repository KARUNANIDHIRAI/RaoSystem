...
<html>
	...
	<body onload="xStdInfo()">
		...
		<div class="container">
			<form id="xfmInfo" name="SchInfo" action="../BooksBorrowed?Action=xBookPurchase" method="post" class="form-horizontal needs-validation" autocomplete="off">
				<br />
				<div class="row">
				...
				<div class="bg-light col-sm-12 offset-sm-0">
					...
					<div class="form-row">
						<div class="col-sm-2 offset-sm-5 ">
							<button type="button" id ="xbkBorrowed" name="subSch01" class="form-control     text-light 
