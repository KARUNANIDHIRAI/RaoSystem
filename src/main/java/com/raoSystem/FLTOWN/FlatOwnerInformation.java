...
public class FlatOwnerInformation extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)	throws ServletException, IOException {
		...
		try {
			user = DAOFltOwner.FlatOwnerInfoRetriev(user);
			...
			case 0: // Record Not Exist [DB]
				...
				response.sendRedirect("SuccessMsf.jsp/OwnMainPage.jsp");
				break;
			case 1: // Record Exist [DB]
				...
				case 0:
					break;
				case 1:
					System.out.println("Step 3. page forward to OwnerInformation/ViewOwnInfo.jsp");
					response.sendRedirect("FLTOwnerInformation/ViewOwnerInfo.jsp");
					break;
				case 2: // Edit Information
					System.out.println("Step 3. page forward to OwnerInformation/EditHKMInfo.jsp");
					response.sendRedirect("FLTOwnerInformation/EditOwnInfo.jsp");
					break;
				}
				break;
			case 2:
				...
				System.out.println("Invalid Email Id  / RWA Registraion No.");
				response.sendRedirect("FLTOwnerInformation/OwnerMainPage.jsp");
				break;
			default:
	...
	private FLTOWNModel SetValueToSessionVar(FLTOWNModel user, HttpSession session) {
