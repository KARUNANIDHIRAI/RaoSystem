...
public class SportItemPurchaseDetailSubModel {
	@Id
	...
	public String toString() {
		return "SportItemPurchaseDetailSubModel [iDDNO=" + iDDNO + ", regNo=" + regNo + ", ItemCode=" + ItemCode
				+ ", itemName=" + itemName + ", ItemSource=" + ItemSource + ", pONO=" + pONO + ", expiryDate="
				+ expiryDate + ", manufactureDate=" + manufactureDate + ", itemQty=" + itemQty + ", unit=" + unit
				+ ", price=" + price + ", tax=" + tax + ", discount=" + discount + ", netAmount=" + netAmount
