...
//	        root.fetch(SMFixedValue.MODEL_ITEMMASTER);
	...
	public static int ItemMasterRemove(ItemMasterModel itemMasterModel) {
		String erMsg = SMFixedValue.ACTION_START + SMFixedValue.ACTION_REMOVING + SMFixedValue.ITEM + SMFixedValue.information;
        int executeUpdate = 0;
    	Transaction transaction = null; 
	    try(Session sessionObj = HibernateDAO.getSessionFactory().openSession()) {
	...
	public static int sprotItemMasterRemove(ItemMasterModel itemMasterModel) {
		String erMsg = SMFixedValue.ACTION_START + SMFixedValue.ACTION_REMOVING + SMFixedValue.SPORTS + SMFixedValue.ITEM + SMFixedValue.information;
        int executeUpdate = 0;
    	Transaction transaction = null; 
	    try(Session sessionObj = HibernateDAO.getSessionFactory().openSession()) {
