...
/**
 * Servlet implementation class UserLoginSMSIInfo
 */
public class UserLoginSMSIInfo extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public UserLoginSMSIInfo() {
        super();
	...
	private UserLoginSMSIModel UpdateUserModel(UserLoginSMSIModel uLModel, HttpServletRequest request, UserSMSIAddress uLAdd ) {
		try {
			...
			uLModel.setlUType(Integer.parseInt(request.getParameter("UserType")));
			...
			uLModel.setStatus(SMFixedValue.STATUS); 
