...
public class SMItemBorrowedSubModel {
	@Id
...
//	private Date actualReturnDate;
	...
	@Column(name = "FacultyCodeFK", nullable = false, updatable = false)
	private int FacultyCodeFK;

	@Column(name = "ItemCodeFK", nullable = false, updatable = false)
	...
	public String toString() {
		return "SMItemBorrowedSubModel [iDNO=" + iDNO + ", regNo=" + regNo + ", admNo=" + admNo + ", facultyCode="
