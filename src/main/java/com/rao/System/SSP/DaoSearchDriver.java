...
public class DaoSearchDriver {
	public static SSPModel DriverCheck(SSPModel user) {
	...
	try {
		...
		case "EDIT":
			...
			ComVar.myStat.setString(4, (String)user.getDOB());
			ComVar.myStat.setString(4, (String)user.getMobileNO());
			ComVar.myStat.setString(4, (String)user.getEmailId());
			ComVar.myStat.setString(4, (String)user.getAadharNO());
			ComVar.myStat.setString(4, (String)user.getPanCardNo());
			ComVar.myStat.setString(4, (String)user.getFFName());
			ComVar.myStat.setString(4, (String)user.getFLName());
			ComVar.myStat.setString(4, (String)user.getFGender());
			ComVar.myStat.setString(4, (String)user.getFMobileNO());
			ComVar.myStat.setString(4, (String)user.getFEmailId());
			ComVar.myStat.setString(4, (String)user.getFAadharNO());
			//sspc Address
			ComVar.myStat.setString(4, (String)user.getCAddress());
			ComVar.myStat.setString(4, (String)user.getCBlock());
			ComVar.myStat.setString(4, (String)user.getCSector());
			ComVar.myStat.setString(4, (String)user.getCCity());
			ComVar.myStat.setString(4, (String)user.getCState());
			ComVar.myStat.setString(4, (String)user.getCCountry());
			ComVar.myStat.setString(4, (String)user.getCZipCode()); 
			// permanent Address    
			ComVar.myStat.setString(4, (String)user.getPAddress());
			ComVar.myStat.setString(4, (String)user.getBlockNO());
			ComVar.myStat.setString(4, (String)user.getSector());
			ComVar.myStat.setString(4, (String)user.getCity());
			ComVar.myStat.setString(4, (String)user.getState());
			ComVar.myStat.setString(4, (String)user.getCountry());
			ComVar.myStat.setString(4, (String)user.getZipCode());
			//ssp Arm Details 
		...
		case "NEW":
			...
			System.out.println(user.getEmailId() + " :" + user.getRwaRegNo()+ " :" +user.getUserID() + " :" +user.getFname()+ " :" +user.getLname()+ " :" +user.getGender()
			+ " :" +user.getDOB()+ " :" +user.getMobileNO()+ " :" +user.getEmailId()+ " :" +user.getAadharNO()+ " :" +user.getPanCardNo()+ " :" +user.getFFName()
			+ " :" +user.getFLName()+ " :" +user.getFGender()+ " :" +user.getFMobileNO()+ " :" +user.getFEmailId()+ " :" +user.getFAadharNO()+ " :" +user.getPAddress()
			+ " :" +user.getBlockNO()+ " :" +user.getSector()+ " :" +user.getCity()+ " :" +user.getState()+ " :" +user.getCountry()+ " :" +user.getZipCode()
			+ " :" +user.getCAddress()+ " :" +user.getCBlock()+ " :" +user.getCSector()+ " :" +user.getCCity()+ " :" +user.getCState()+ " :" +user.getCCountry()
			+ " :" +user.getCZipCode()+ " :" +user.getArmsNo()+ " :" +user.getArmsType()+ " :" +user.getArmsMadeFromCity()+ " :" +user.getArmsPurchaseFrom()
			+ " :" +user.getArmsPurchaseYear()+ " :" +user.getArmsIssuedInName());


			System.out.println(user.getDLNO() + " :" + user.getDLIssuefromCity()+ " :" +user.getDLIssueDate() + " :" +user.getDLExpiryDate()
			+ " :" +user.getOrgName()+ " :" +user.getEmployeeNo() + " :" +user.getDesignation()+ " :" +user.getDOJ()+ " :" +user.getDOR()
			+ " :" +user.getReportingOfficer()+ " :" +user.getOEmailID() + " :" +user.getOAdress()    + " :" +user.getOBlock()+ " :" 
			+user.getOSector()+ " :" +user.getOCity()+ " :" +user.getOState()+ " :" +user.getOcountry()+ " :" +user.getOPinCode());
			
	
			/*	System.out.println(user.getDLIRTOAddress() + " :" + user.getDLBlockNO()+ " :" +user.getDLSector() + " :" +user.getDLCity()
				+ " :" +user.getDLState()+ " :" +user.getDLCountry() + " :" +user.getDLZipCode()); 	*/		
